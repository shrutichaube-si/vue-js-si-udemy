            ...
            <div class="table-head">
                <div class="table-row">
                    ...
                    <div class="table-data matches-team">
                        <p class="text">Clubs</p>
                    </div>
                    <div class="table-data matches-play">
                        <p class="text">Played</p>
                    </div>
                    <div class="table-data matches-won">
                        <p class="text">Won</p>
                    </div>
                    <div class="table-data matches-draw">
                        <p class="text">Draw</p>
                    </div>
                    <div class="table-data matches-lost">
                        <p class="text">Lost</p>
                    </div>
                    <div class="table-data matches-goal-for">
                        <p class="text">GF</p>
                    </div>
...
<div class="table-body" v-for="(team,index) in players" :key="index">
