...
import FileRenameFormVue from '../components/files/FileRenameForm.vue';
...
export default {
  ...
  components: { ActionBar, IconTypeCommon, FilesList,SortToggler, SearchForm,FileRenameFormVue},
  setup(){
    const files = ref([]);
     ...
     const handleRemove = ()=>{
        if(confirm("Are you sure?")){
          ...
          toast.show=true;
          toast.message="selected itrem successfully removed";
        }
      }
